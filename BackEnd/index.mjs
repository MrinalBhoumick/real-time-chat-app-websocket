...
// KMS client and key ARN
const kms = new AWS.KMS();
const KMS_KEY_ARN = 'arn:aws:kms:ap-south-1:992382729083:key/6b4e3ceb-8199-4606-ba57-262fd4d5f4be';
...
const sendToOne = async (id, body) => {
    try {
        const encryptedBody = await encryptMessage(JSON.stringify(body));
        await client.postToConnection({
            'ConnectionId': id,
            'Data': Buffer.from(encryptedBody),
        }).promise();
    } catch (err) {
